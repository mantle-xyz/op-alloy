...
mod tests {
    ...
    fn test_calculate_tx_l1_cost_bedrock() {
        ...
        let gas_cost =
            calculate_tx_l1_cost_bedrock(&input, l1_fee_overhead, base_fee, l1_fee_scalar, token_ratio);
    ...
    fn test_calculate_tx_l1_cost_regolith() {
        ...
        let input = bytes!("FACADE");
        let gas_cost =
            calculate_tx_l1_cost_regolith(&input, l1_fee_overhead, base_fee, l1_fee_scalar, token_ratio);
